...
class CustomRegisterSerializerTest(TestCase):
    ...
    def test_duplicate_email_validation(self):
        ...
        Users.objects.create_user(
            username="existing", email="john@example.com", password="password123"
        )
    ...
    def test_duplicate_username_validation(self):
        ...
        # Create a user first
        Users.objects.create_user(
            username="john_doe", email="different@example.com", password="password123"
        )
...
class AccountViewsTest(APITestCase):
    ...
    def test_get_user_by_filter_with_both_params(self):
        ...
        response = self.client.get(
            url, {"username": "testuser", "email": "test@example.com"}
        )
    ...
    def test_manage_user_delete_authenticated(self):
        ...
        self.assertEqual(response.status_code, status.HTTP_200_OK)
        self.assertIn("excluída com sucesso", response.data["message"])
